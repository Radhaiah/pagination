...
let prevpage = document.querySelector("#Previous");
prevpage.addEventListener("click", function () {
  displayEmployees10(employees);
});
let displayEmployees10 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
...
page2.addEventListener("click", function () {
  displayEmployees1(employees);
});
let displayEmployees1 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>10 && employee.id<=20){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
...
page3.addEventListener("click", function () {
  displayEmployees2(employees);
});
let displayEmployees2 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>20 && employee.id<=30){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
...
page4.addEventListener("click", function () {
  displayEmployees3(employees);
});
let displayEmployees3 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>30 && employee.id<=40){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
...
page5.addEventListener("click", function () {
  displayEmployees4(employees);
});
let displayEmployees4 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>40 && employee.id<=50){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
...
page6.addEventListener("click", function () {
  displayEmployees5(employees);
});
let displayEmployees5 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>50 && employee.id<=60){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
...
page7.addEventListener("click", function () {
  displayEmployees6(employees);
});
let displayEmployees6 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>60 && employee.id<=70){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
...
page8.addEventListener("click", function () {
  displayEmployees7(employees);
});
let displayEmployees7 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>70 && employee.id<=80){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
...
page9.addEventListener("click", function () {
  displayEmployees8(employees);
});
let displayEmployees8 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>80 && employee.id<=90){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
...
page10.addEventListener("click", function () {
  displayEmployees9(employees);
});
let displayEmployees9 = (employees) => {
  //select the table body
  let tableBody = document.querySelector("#table-body");
  //create a row which is empty and append it to the table body
  let tablerow = "";
  for (let employee of employees) {
    if(employee.id>90 && employee.id<=100){
    tablerow += `<tr>
    <td>${employee.id}</td>
    <td>${employee.name}</td>
    <td>${employee.email}</td>   
